# from tkinter import *
# window = Tk()  #title of our window
# #inp = Label(window, text = "hello word")

# #now we are adding a title 
# window.title("simple")
# window.geometry("500x700")
# window.config(bg = "yellow")

# frame1 = Frame(window , bg = "red" , width = 300 , height = 300)
# frame2 = Frame(window , bg = "green" , width = 300 , height = 300)
# frame1.pack(side=TOP)
# frame2.pack(side=BOTTOM)

# # button1 = Button(frame1 , text = "Button1" , bg = "blue")
# # button2 = Button(frame2 , text = "Button1" , bg = "light green")
